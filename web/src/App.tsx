        ...
        <div>
          ...
          {dumpMs > 0 && (
            <p className="report-date">
              Captured <strong>{formatDateNice(dumpMs)}</strong>
              {" · "}
              <span className="report-date-iso" title={formatEpochMs(dumpMs)}>{formatEpochMs(dumpMs)}</span>
            </p>
          )}
        </div>
      </div>
      <div className="report-tool-bar">
        <span className="report-tool-name">
          Generated by{" "}
          <a href="https://github.com/parttimenerd/hprof-analyzer" target="_blank" rel="noopener">
            hprof-analyzer
          </a>{" "}
          — fast Java heap dump analysis
        </span>
        <span className="report-tool-links">
          ...
          {" · "}
          <span className="report-self-contained" title="This HTML file is fully self-contained — it can be opened offline, emailed, or archived and will always render correctly.">
            📦 Self-contained HTML
          </span>
        </span>
        <span className="report-sizes-note">
          All sizes are binary (1&nbsp;KB = 1024 bytes, 1&nbsp;MB = 1024&nbsp;KB).
        </span>
      </div>
    </div>
  );

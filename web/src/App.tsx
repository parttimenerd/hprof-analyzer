...
function GlossarySection() {
  const entries: [string, React.ReactNode][] = [
    ...
    ["Only-Weakly Retained", <>an object that has no incoming strong reference — reachable only through <code>WeakReference</code> or <code>SoftReference</code> chains. Weak-only referents are collected at the next GC cycle; soft-only referents are collected under memory pressure.</>],

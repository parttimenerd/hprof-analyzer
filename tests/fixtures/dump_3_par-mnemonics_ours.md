...
*Generated by hprof-analyzer views — 2026-07-23T07:04:48.648008000Z*
...
- `java.util.concurrent.ForkJoinTask.awaitDone (ForkJoinTask.java:461)`
  - `java.util.stream.ReduceOps$ReduceTask` retains 4.2 MB (22.0%)
...
- `java.util.concurrent.ForkJoinPool.awaitWork (ForkJoinPool.java:1893)`
  - `java.util.concurrent.ForkJoinPool$WorkQueue[]` retains 1.0 KB (0.0%)
  - `java.util.concurrent.ForkJoinPool$WorkQueue` retains 328 B (0.0%)
  - `java.util.concurrent.ForkJoinPool` retains 144 B (0.0%)
...
_Unreachable objects are eligible for collection but have not yet been reclaimed. At 5.6% of total heap this is elevated — the JVM may not have had time to GC before the dump was taken, or finalization may be backed up._

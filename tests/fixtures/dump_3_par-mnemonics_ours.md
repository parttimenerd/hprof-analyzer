...
*Generated by hprof-analyzer views — 2026-07-23T07:54:25.205350000Z*
...
- `java.util.concurrent.ForkJoinTask.awaitDone (ForkJoinTask.java:461)`
  ...
  - `java.util.concurrent.ForkJoinPool$WorkQueue` retains 328 B (0.0% of thread retained)
  - `java.util.concurrent.ForkJoinPool` retains 144 B (0.0% of thread retained)
  - `java.util.concurrent.ForkJoinTask$Aux` retains 24 B (0.0% of thread retained)
...
- `java.util.stream.ReduceOps$ReduceOp.evaluateParallel (ReduceOps.java:927)`
  - `java.util.concurrent.ConcurrentHashMap$EntrySpliterator` retains 56 B (0.0% of thread retained)
  - `java.util.stream.ReferencePipeline$7` retains 56 B (0.0% of thread retained)
  - `java.util.stream.ReduceOps$3` retains 32 B (0.0% of thread retained)
...
- `java.util.stream.ReferencePipeline.collect (ReferencePipeline.java:682)`
  - `java.util.stream.ReferencePipeline$7` retains 56 B (0.0% of thread retained)
  - `java.util.stream.Collectors$CollectorImpl` retains 32 B (0.0% of thread retained)
- `org.renaissance.jdk.streams.MnemonicsCoderWithStream.parallelEncode (MnemonicsCoderWithStream.java:107)`
  - `org.renaissance.jdk.streams.MnemonicsCoderWithStream` retains 2.8 KB (0.0% of thread retained)
  - `java.lang.String` retains 80 B (0.0% of thread retained)
  - `java.util.HashSet` retains 64 B (0.0% of thread retained)
  - `java.util.stream.ReferencePipeline$Head` retains 56 B (0.0% of thread retained)
  - `java.util.stream.ReferencePipeline$Head` retains 56 B (0.0% of thread retained)
...
- `org.renaissance.jdk.streams.ParMnemonics.run (ParMnemonics.scala:79)`
  - `org.renaissance.jdk.streams.ParMnemonics` retains 24 B (0.0% of thread retained)
...
- `java.util.concurrent.ForkJoinPool.awaitWork (ForkJoinPool.java:1893)`
  - `java.util.concurrent.ForkJoinPool$WorkQueue[]` retains 1.0 KB (0.0% of thread retained)
  - `java.util.concurrent.ForkJoinPool$WorkQueue` retains 328 B (0.0% of thread retained)
  - `java.util.concurrent.ForkJoinPool` retains 144 B (0.0% of thread retained)
...
- `java.lang.StringLatin1$CharsSpliterator.forEachRemaining (StringLatin1.java:811)`
  - `java.util.stream.IntPipeline$1$1` retains 152 B (0.0% of thread retained)
  - `byte[]` retains 24 B (0.0% of thread retained)
...
- `java.util.stream.AbstractPipeline.wrapAndCopyInto (AbstractPipeline.java:499)`
  - `java.util.stream.ReduceOps$3ReducingSink` retains 88 B (0.0% of thread retained)
- `java.util.stream.Collectors.lambda$groupingBy$53 (Collectors.java:1105)`
  - `java.util.HashMap` retains 1.8 KB (0.0% of thread retained)
  - `java.lang.String` retains 24 B (0.0% of thread retained)
  - `java.util.stream.Collectors$$Lambda+0x00007c849406e898` retains 16 B (0.0% of thread retained)
  - `java.util.stream.Collectors$$Lambda+0x00007c849406eab8` retains 16 B (0.0% of thread retained)
- `java.util.Spliterators$ArraySpliterator.forEachRemaining (Spliterators.java:1024)`
  - `java.lang.String[]` retains 160 B (0.0% of thread retained)
  - `java.util.stream.ReduceOps$3ReducingSink` retains 32 B (0.0% of thread retained)
- `java.util.stream.AbstractPipeline.copyInto (AbstractPipeline.java:509)`
  - `java.util.stream.ReduceOps$3ReducingSink` retains 32 B (0.0% of thread retained)
- `java.util.stream.AbstractPipeline.wrapAndCopyInto (AbstractPipeline.java:499)`
  - `java.util.stream.ReduceOps$3ReducingSink` retains 32 B (0.0% of thread retained)
...
- `org.renaissance.jdk.streams.MnemonicsCoderWithStream.encode (MnemonicsCoderWithStream.java:62)`
  - `org.renaissance.jdk.streams.MnemonicsCoderWithStream` retains 2.8 KB (0.0% of thread retained)
  - `java.util.HashSet` retains 64 B (0.0% of thread retained)
  - `java.lang.String` retains 56 B (0.0% of thread retained)
- `org.renaissance.jdk.streams.MnemonicsCoderWithStream.lambda$encode$9 (MnemonicsCoderWithStream.java:67)`
  - `java.lang.String` retains 56 B (0.0% of thread retained)
  - `java.lang.String` retains 48 B (0.0% of thread retained)
- `java.util.stream.ReferencePipeline$3$1.accept (ReferencePipeline.java:197)`
  - `java.util.stream.ReferencePipeline$7$1` retains 24 B (0.0% of thread retained)
- `java.util.ArrayList$ArrayListSpliterator.forEachRemaining (ArrayList.java:1708)`
  - `java.util.ArrayList$ArrayListSpliterator` retains 32 B (0.0% of thread retained)
...
_Unreachable objects are eligible for collection but have not yet been reclaimed. At 5.6% of reachable heap this is elevated — the JVM may not have had time to GC before the dump was taken, or finalization may be backed up._

...
*Generated by hprof-analyzer views — 2026-07-22T21:33:09.185787000Z*
...
- **Fixed per-object header overhead:** 517,791 objects × 12 B header = 5.9 MB (30.9% of heap) is consumed by JVM object headers alone — consider value types, primitive arrays, or fewer wrapper objects. See [Object Header Overhead](#object-header-overhead).
...
| Class loaders                            | 5                                  |
| Unreachable objects (excluded)           | 3,908 (1.1 MB; 5.6% of total heap) |
| Heap fragmentation (unreachable / total) | 5.6%                               |
...
| -: | --------------------- | --------: | ------------: | --------: | -------: |
|  1 | `java.lang.Long`      |       256 |        6.0 KB |     0.03% |     24 B |
|  2 | `java.lang.Integer`   |       277 |        4.3 KB |     0.02% |     16 B |
|  3 | `java.lang.Byte`      |       256 |        4.0 KB |     0.02% |     16 B |
|  4 | `java.lang.Short`     |       256 |        4.0 KB |     0.02% |     16 B |
...
- `java.util.HashMap$Node[]` (shallow 512.0 KB, retained 8.4 MB)
  ...
  - `java.util.HashMap$Node` ×21 (shallow 32 B, retained 504 B each)
    ...
    - `java.lang.String` (shallow 24 B, retained 96 B)
      - `byte[]` (shallow 72 B, retained 72 B)
  - `java.util.HashMap$Node` ×3 (shallow 32 B, retained 496 B each)
    - `java.util.HashMap$Node` (shallow 32 B, retained 376 B)
      - `java.util.HashMap$Node` (shallow 32 B, retained 256 B)
        - `java.util.HashMap$Node` (shallow 32 B, retained 128 B)
          - `java.lang.String` (shallow 24 B, retained 96 B)
    ...
    - `java.lang.String` (shallow 24 B, retained 88 B)
      - `byte[]` (shallow 64 B, retained 64 B)
  - `java.util.HashMap$Node` ×269 (shallow 32 B, retained 384 B each)
    - `java.util.HashMap$Node` (shallow 32 B, retained 256 B)
      - `java.util.HashMap$Node` (shallow 32 B, retained 128 B)
        - `java.lang.String` (shallow 24 B, retained 96 B)
          - `byte[]` (shallow 72 B, retained 72 B)
...
| `java.util.stream.ReduceOps$ReduceTask`     |  76746 |      4.2 MB | `java.util.stream.ReduceOps$ReduceTask`    |         4.2 MB |        64 B |
| `java.util.stream.ReduceOps$ReduceTask`     |  76858 |      4.2 MB | `java.util.stream.ReduceOps$3ReducingSink` |         4.2 MB |        64 B |
| `java.util.HashMap`                         |  52082 |    577.2 KB | `java.util.HashMap$Node[]`                 |       577.2 KB |        48 B |
| `java.util.HashMap`                         |  76836 |      4.2 MB | `java.util.HashMap$Node[]`                 |         4.2 MB |        48 B |
| `java.util.HashMap`                         |  76977 |      8.4 MB | `java.util.HashMap$Node[]`                 |         8.4 MB |        48 B |
| `java.util.HashMap`                         | 274046 |    309.0 KB | `java.util.HashMap$Node[]`                 |       309.0 KB |        48 B |
| `java.lang.ref.SoftReference`               | 435741 |    584.8 KB | `java.util.jar.Manifest`                   |       584.7 KB |        40 B |
| `java.util.stream.ReduceOps$3ReducingSink`  |  76866 |      4.2 MB | `java.util.HashSet`                        |         4.2 MB |        32 B |
| `java.util.stream.ReduceOps$3ReducingSink`  |  76975 |      8.4 MB | `java.util.HashSet`                        |         8.4 MB |        32 B |
| `java.util.stream.ReduceOps$3ReducingSink`  | 274040 |    309.1 KB | `java.util.HashSet`                        |       309.0 KB |        32 B |
| `java.util.HashSet`                         |  76835 |      4.2 MB | `java.util.HashMap`                        |         4.2 MB |        16 B |
| `java.util.HashSet`                         |  76976 |      8.4 MB | `java.util.HashMap`                        |         8.4 MB |        16 B |
...
_… (+9 deeper buckets, 32 objects, 10000.0% cumulative — full data in JSON)_

...
*Generated by hprof-analyzer views — 2026-07-22T21:32:45.332535000Z*
...
- **Fixed per-object header overhead:** 334,875 objects × 12 B header = 3.8 MB (34.1% of heap) is consumed by JVM object headers alone — consider value types, primitive arrays, or fewer wrapper objects. See [Object Header Overhead](#object-header-overhead).
...
| `java.util.HashMap`                             |  29482 |    577.2 KB | `java.util.HashMap$Node[]`                      |       577.2 KB |        48 B |                  |
| `java.util.HashMap`                             |  81107 |      4.2 MB | `java.util.HashMap$Node[]`                      |         4.2 MB |        48 B |                  |
| `java.util.HashMap`                             |  83760 |    309.0 KB | `java.util.HashMap$Node[]`                      |       309.0 KB |        48 B |                  |
| `java.util.HashMap`                             |  89769 |    611.9 KB | `java.util.HashMap$Node[]`                      |       611.9 KB |        48 B |                  |
| `java.lang.ref.SoftReference`                   |  29413 |    584.8 KB | `java.util.jar.Manifest`                        |       584.7 KB |        40 B |                  |
| `java.util.stream.ReduceOps$3ReducingSink`      |  80310 |    612.0 KB | `java.util.HashSet`                             |       612.0 KB |        32 B |                  |
| `java.util.stream.ReduceOps$3ReducingSink`      |  80630 |    309.1 KB | `java.util.HashSet`                             |       309.0 KB |        32 B |                  |

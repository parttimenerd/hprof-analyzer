...
*Generated by hprof-analyzer views — 2026-07-23T07:54:20.186251000Z*
...
- `scala.collection.IterableOnceOps.count (IterableOnce.scala:618)`
  - `scala.collection.immutable.SetIterator` retains 160 B (0.0% of thread retained)
- `scala.collection.IterableOnceOps.exists (IterableOnce.scala:604)`
  - `scala.collection.immutable.SetIterator` retains 160 B (0.0% of thread retained)
  - `cafesat.sat.Solver$$Lambda+0x00007de4a41f5a08` retains 16 B (0.0% of thread retained)
- `scala.collection.IterableOnceOps.exists$ (IterableOnce.scala:601)`
  - `cafesat.sat.Solver$$Lambda+0x00007de4a41f5a08` retains 16 B (0.0% of thread retained)
  - `scala.collection.immutable.HashSet` retains 16 B (0.0% of thread retained)
...
- `scala.collection.immutable.List.foreach (List.scala:333)`
  ...
  - `cafesat.sat.Solver$$Lambda+0x00007de4a41f7bd0` retains 24 B (0.0% of thread retained)
...
- `cafesat.sat.Solver.solve (Solver.scala:147)`
  - `cafesat.sat.Solver` retains 4.6 MB (15.5% of thread retained)
  - `cafesat.sat.Literal[]` retains 16 B (0.0% of thread retained)
  - `scala.collection.immutable.Nil$` retains 16 B (0.0% of thread retained)
- `cafesat.api.Solver$.solveForSatisfiability (Solver.scala:84)`
  ...
  - `cafesat.api.Formulas$Formula` retains 16 B (0.0% of thread retained)
  - `cafesat.api.Solver$` retains 16 B (0.0% of thread retained)

...
*Generated by hprof-analyzer views — 2026-07-23T07:04:48.269757000Z*
...
- `cafesat.sat.Solver.$anonfun$initClauses$1 (Solver.scala:124)`
  - `scala.runtime.ObjectRef` retains 962.1 KB (3.2%)
  - `scala.collection.immutable.HashSet` retains 16 B (0.0%)
- `scala.collection.immutable.List.foreach (List.scala:333)`
  - `scala.collection.immutable.$colon$colon` retains 3.2 MB (10.9%)
  - `cafesat.sat.Solver$$Lambda+0x00007de4a41f7bd0` retains 24 B (0.0%)
- `cafesat.sat.Solver.initClauses (Solver.scala:115)`
  - `cafesat.sat.Solver` retains 4.6 MB (15.5%)
  - `scala.collection.immutable.$colon$colon` retains 962.2 KB (3.2%)
  - `scala.runtime.ObjectRef` retains 962.1 KB (3.2%)
...
- `cafesat.api.Solver$.solveForSatisfiability (Solver.scala:84)`
  - `cafesat.asts.core.Trees$ConnectiveApplication` retains 208.8 KB (0.7%)
...
_… 2 more classes (2 objects, 32 B shallow)._
...
_Unreachable objects are eligible for collection but have not yet been reclaimed. A small unreachable heap (< 5%) is normal between GC cycles._

...
*Generated by hprof-analyzer views — 2026-07-23T06:50:44.990497000Z*
...
| Class loaders                            | 6                                    |
| Unreachable objects (excluded)           | 60,900 (4.3 MB; 11.6% of total heap) |
| Heap fragmentation (unreachable / total) | 11.6%                                |
...
- `java.lang.Class` (5,007 objects, retained 5.4 MB)
  - `jdk.internal.reflect.AccessorGenerator` (1 object, retained 2.5 KB) — GC root: Sticky Class
  - `java.io.ObjectStreamClass` (1 object, retained 2.5 KB) — GC root: Sticky Class
  - `java.io.ObjectOutputStream` (1 object, retained 1.2 KB) — GC root: Sticky Class
  - `org.apache.spark.rdd.MapPartitionsRDD` (1 object, retained 512 B)
  - `java.io.ObjectStreamClass$Caches` (1 object, retained 472 B) — GC root: Sticky Class
  - `jdk.internal.reflect.MethodAccessorGenerator` (1 object, retained 320 B) — GC root: Sticky Class
  - `java.util.logging.SimpleFormatter` (1 object, retained 280 B) — GC root: Sticky Class
  - `java.io.SerialCallbackContext` (1 object, retained 256 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$FieldReflector` (1 object, retained 232 B) — GC root: Sticky Class
  - `java.util.zip.Deflater` (1 object, retained 216 B) — GC root: Sticky Class
  - `java.time.ZonedDateTime` (1 object, retained 136 B) — GC root: Sticky Class
  - `jdk.internal.reflect.UTF8` (1 object, retained 120 B) — GC root: Sticky Class
  - `java.util.zip.DeflaterOutputStream` (1 object, retained 112 B) — GC root: Sticky Class
  - `jdk.internal.reflect.ClassFileAssembler` (1 object, retained 112 B) — GC root: Sticky Class
  - `jdk.internal.reflect.ClassFileConstants` (1 object, retained 104 B) — GC root: Sticky Class
  - `java.time.chrono.ChronoZonedDateTime` (1 object, retained 96 B) — GC root: Sticky Class
  - `jdk.internal.reflect.ClassDefiner` (1 object, retained 88 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$2` (1 object, retained 48 B) — GC root: Sticky Class
  - `org.apache.spark.SparkContext$$Lambda+0x00007b0ac06ed830` (1 object, retained 48 B)
  ...
  - `java.io.ObjectOutput` (1 object, retained 24 B) — GC root: Sticky Class
  - `jdk.internal.reflect.ByteVector` (1 object, retained 24 B) — GC root: Sticky Class
  - `java.io.ObjectOutputStream$BlockDataOutputStream` (1 object, retained 16 B) — GC root: Sticky Class
  - `java.util.zip.GZIPOutputStream` (1 object, retained 16 B) — GC root: Sticky Class
  - `java.io.IOException` (1 object, retained 8 B) — GC root: Sticky Class
  - `java.io.ClassCache` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ClassCache$1` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ClassCache$CacheRef` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectOutputStream$HandleTable` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectOutputStream$ReplaceTable` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$1` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$3` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$4` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$5` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$Caches$1` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$Caches$2` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$ClassDataSlot` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$ExceptionInfo` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$FieldReflectorKey` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.io.ObjectStreamClass$MemberSignature` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.lang.Module$$Lambda+0x00007b0ac0041e98` (1 object, retained 0 B) — GC root: Sticky Class
  - `java.lang.ThreadLocal$ThreadLocalMap$Entry[]` (1 object, retained 0 B)
  ...
  - `java.nio.file.LinkOption[]` (1 object, retained 0 B)
  - `java.security.ProtectionDomain[]` (1 object, retained 0 B)
  - `java.util.logging.Level[]` (1 object, retained 0 B)
  - `jdk.internal.reflect.ByteVectorFactory` (1 object, retained 0 B) — GC root: Sticky Class
  - `jdk.internal.reflect.ByteVectorImpl` (1 object, retained 0 B) — GC root: Sticky Class
  - `jdk.internal.reflect.ClassDefiner$1` (1 object, retained 0 B) — GC root: Sticky Class
  - `jdk.internal.reflect.Label` (1 object, retained 0 B) — GC root: Sticky Class
  - `jdk.internal.reflect.Label$PatchInfo` (1 object, retained 0 B) — GC root: Sticky Class
  - `jdk.internal.reflect.MethodAccessorGenerator$1` (1 object, retained 0 B) — GC root: Sticky Class
  - `jdk.internal.reflect.SerializationConstructorAccessorImpl` (1 object, retained 0 B) — GC root: Sticky Class
  - `sun.nio.cs.UTF_8$Encoder` (1 object, retained 0 B) — GC root: Sticky Class
  - `sun.nio.fs.NativeBuffer[]` (1 object, retained 0 B)

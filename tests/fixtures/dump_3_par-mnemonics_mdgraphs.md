...
| ---------------------------------------------------- | ------: | --------: | -----------: | ------------: | ---------------- |
| <boot>                                               |   1,748 |   517,340 |      19.2 MB |       48.4 MB | ████████████████ |
| java/net/URLClassLoader                              |     575 |       330 |      18.0 KB |        2.6 MB | ▊                |
| jdk/internal/loader/ClassLoaders$AppClassLoader      |      90 |        68 |       1.4 KB |       21.8 KB | ▏                |
| jdk/internal/loader/ClassLoaders$PlatformClassLoader |       1 |         1 |         16 B |        7.4 KB | ▏                |
| java/net/URLClassLoader                              |      30 |        52 |       1.0 KB |        2.7 KB | ▏                |
...
| -: | ------------------------- | -------: | -----: | ---------------- |
|  1 | `byte[]`                  |   7.2 MB |  37.6% | ████████████████ |
|  2 | `java.lang.String`        |   2.8 MB |  14.5% | ██████▏          |
|  3 | `java.net.URLClassLoader` |   2.6 MB |  13.6% | █████▊           |
|  4 | `java.util.HashMap`       |   2.0 MB |  10.4% | ████▍            |
...
_Directly dominates 39,727 objects (showing top 50)._

**Accumulated objects (top 50 by retained heap):**

| Class                    | Shallow | Retained |
| ------------------------ | ------: | -------: |
| `java.util.HashMap$Node` |    32 B |     88 B |
| `java.util.HashMap$Node` |    32 B |     64 B |
| `java.util.HashMap$Node` |    32 B |     64 B |
| `java.util.HashMap$Node` |    32 B |     64 B |
| `java.util.HashMap$Node` |    32 B |     64 B |
| `java.util.HashMap$Node` |    32 B |     64 B |
...
| Class                    | Objects | Shallow | Retained |
| ------------------------ | ------: | ------: | -------: |
| `java.util.HashMap$Node` |  39,727 |  1.2 MB |   1.5 MB |
...
├─ java.util.HashMap$Node (shallow 32 B, retained 64 B)
...
| ├─ `util`          |  34,435 |  1.4 MB |   5.0 MB | ███████▎         |
| │  ├─ `zip`        |      24 |   504 B | 448.9 KB | ▋                |
| │  └─ `concurrent` |   1,745 | 83.1 KB | 264.8 KB | ▍                |
| ├─ `lang`          | 112,741 |  2.7 MB |   3.2 MB | ████▋            |
| └─ `net`           |      24 |  1.1 KB |   2.6 MB | ███▊             |
| `(primitives)`     | 109,028 |  7.2 MB |   7.3 MB | ██████████▊      |
| `jdk`              |     698 | 20.3 KB | 903.7 KB | █▎               |
| └─ `internal`      |     695 | 20.3 KB | 903.6 KB | █▎               |
|    └─ `loader`     |      44 |   792 B | 773.6 KB | █                |

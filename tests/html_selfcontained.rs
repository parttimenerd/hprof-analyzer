...
fn bundle_is_within_size_budget() {
    ...
    // in every HTML file. Budget: <= 600 KB minified (raised from 450 KB to
    // accommodate d3-dag for the unreachable dominator-tree SVG visualization).

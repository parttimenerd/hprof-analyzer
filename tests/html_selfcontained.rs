...
fn bundle_is_within_size_budget() {
    // Budget: <= 1100 KB minified (raised to accommodate expandable histogram rows,
    // field scan, object explorer, and other UI features).
    // Keep in sync with web/esbuild.config.mjs budgetBytes.

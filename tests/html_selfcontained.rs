...
fn bundle_is_within_size_budget() {
    ...
    // in every HTML file. Budget: <= 720 KB minified (raised from 600 KB to
    // accommodate react-data-table-component and related UI components).
